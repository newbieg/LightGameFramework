// part way through the tutorials, I suggest compiling to 
// ensure things are running correctly. this is about where
// you should be.
// I did go ahead and change the frame rate since 30 fps is 
// a bit excessive on a simple program like this.
#include "sprite.h"
